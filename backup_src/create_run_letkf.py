...
# Parameters for the data assimilation
           ...
           "DA_PARAMS" : {
                           ...
                           "additive_noisef":   True,       # type(int): whether to add noise based on reflectivity obs after assimilation to maintain spread
                           "mpass":             False,
                           "writeFcstMean":     True,
                           "writeAnalMean":     True,
                           "saveWeights":       False,
...
if not os.path.exists(defaults['fcst_path']):
    os.mkdir(defaults['fcst_path'])
